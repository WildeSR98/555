...
2. [Установка PostgreSQL](#1️⃣-установка-postgresql)
3. [Настройка сетевого доступа](#2️⃣-настройка-сетевого-доступа)
4. [Создание базы данных и пользователя](#3️⃣-создание-базы-данных-и-пользователя)
5. [Подготовка приложения](#4️⃣-подготовка-приложения)
6. [Миграция данных](#5️⃣-миграция-данных)
7. [Проверка работы](#6️⃣-проверка-работы)
8. [Решение проблем](#8️⃣-решение-проблем)
